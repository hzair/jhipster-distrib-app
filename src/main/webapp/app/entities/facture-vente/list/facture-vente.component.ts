...
export class FactureVenteComponent implements OnInit {
    ...
    this.factureVenteService
      ...
      .subscribe({
        next: (res: HttpResponse<IFactureVente[]>) => {
          ...
          this.paginateFactureVentes(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateFactureVentes(data: IFactureVente[] | null, headers: HttpHeaders): void {
