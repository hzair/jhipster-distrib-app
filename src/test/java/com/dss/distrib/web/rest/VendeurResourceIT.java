...
class VendeurResourceIT {
    ...
    void createVendeur() throws Exception {
        ...
        assertThat(testVendeur.getDesignation()).isEqualTo(DEFAULT_DESIGNATION);
    ...
    void putNewVendeur() throws Exception {
        ...
        assertThat(testVendeur.getDesignation()).isEqualTo(UPDATED_DESIGNATION);
