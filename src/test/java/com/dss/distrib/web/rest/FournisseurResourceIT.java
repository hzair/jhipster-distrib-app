...
class FournisseurResourceIT {
    ...
    void createFournisseur() throws Exception {
        ...
        assertThat(testFournisseur.getDesignation()).isEqualTo(DEFAULT_DESIGNATION);
    ...
    void checkDesignationIsRequired() throws Exception {
        int databaseSizeBeforeTest = fournisseurRepository.findAll().size();
        // set the field null
        fournisseur.setDesignation(null);
    ...
    void putNewFournisseur() throws Exception {
        ...
        assertThat(testFournisseur.getDesignation()).isEqualTo(UPDATED_DESIGNATION);
    ...
    void partialUpdateFournisseurWithPatch() throws Exception {
        ...
        partialUpdatedFournisseur.matricule(UPDATED_MATRICULE).designation(UPDATED_DESIGNATION).nom(UPDATED_NOM);
